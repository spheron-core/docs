...
The **[Spheron Protocol SDK for Node.js](https://github.com/spheron-core/protocol-sdk/tree/main/nodejs)** provides a comprehensive set of modules to interact with the Spheron decentralized infrastructure. This includes modules for lease management, deployment operations, and escrow functionality.
...
For detailed examples of how to use each module, please refer to the [Examples Directory](https://github.com/spheron-core/protocol-sdk/tree/main/examples).
