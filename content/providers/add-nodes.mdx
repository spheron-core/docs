...
If you haven't already, clone the Spheron provider deployment repository: [spheron-core/provider-installation](https://github.com/spheron-core/provider-installation)

```
git clone https://github.com/spheron-core/provider-installation.git
```

Repo has the following file structure: 

<FileTree>
  <FileTree.Folder name="provider-installation" defaultOpen>
...
```
```
wget -q https://raw.githubusercontent.com/spheron-core/provider-installation/main/scripts/add-agent.sh
```
...
```
sphnctl wallet use --name wallet --wallet-secret testPassword
```
```
