...
If you haven't already, clone the Spheron provider deployment repository: [spheron-core/provider-deployment](https://github.com/spheron-core/provider-deployment)

```
git clone https://github.com/spheron-core/provider-deployment.git
```
...
```
```
wget -q https://raw.githubusercontent.com/spheron-core/provider-deployment/main/scripts/add-agent.sh
```
