...
Clone this repo onto your local system: GitHub - [spheron-core/provider-installation](https://github.com/spheron-core/provider-installation)

```sh
git clone https://github.com/spheron-core/provider-installation
```
...
<FileTree>
  <FileTree.Folder name="provider-installation" defaultOpen>
    ...
    <FileTree.Folder name="scripts" defaultOpen>
      ...
      <FileTree.File name="only-provider.sh" />
