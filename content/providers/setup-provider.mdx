...
git clone https://github.com/spheron-core/spheron-stack.git
cd spheron-stack/charts
...
wget https://spheron-release.s3.us-east-1.amazonaws.com/v2/crd.yaml
...
```
```sh
cd /home/spheron/spheron-stack/charts
